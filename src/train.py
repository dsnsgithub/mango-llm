...
from parse_dataset import StoryDataset, collate_fn
...
def train():
    ...
    loaded_dataset = DataLoader(dataset, batch_size=BATCH_SIZE, shuffle=False, collate_fn=collate_fn)
    ...
    for epoch in range(1, EPOCH_COUNT + 1):
        ...
        for step, (inputs, targets) in enumerate(loaded_dataset):
            ...
            if step % SAVE_ON_STEP == 0 and step != 0:
                ...
                time_taken = end_step - start_step
